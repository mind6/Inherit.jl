...
"""
module Inherit
export @abstractbase, @implement, @interface, @postinit, InterfaceError, ImplementError, SettingsError, (<--), setglobalreportlevel, setreportlevel, ThrowError, ShowMessage, SkipInitCheck
